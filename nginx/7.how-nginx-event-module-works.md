...
Instance was put forward to solving such questions. The last bit in address of a socket is different in such case made sure by this design. If last bit of the privous socket is 0, and the next one will be 1 at last bit.  
@todo: how about two sockets destorying-creating, 1+1=0 will also cause this question. 
